...
# -*- coding: utf-8 -*-
"""
This script downloads genome files in fasta format for accessions of interest. Fastas are then inputted into Prokka to generate GFF files and used as an input into panaroo. This script specifies 5 pneumnococcus reference genomes and currently is set works on mac but both of these can be adapted easily
"""
...
Accessions = ['NZ_AKVY01000001.1'] #'NZ_AKVY01000001.1'
Accessions = ['NC_017592.1'] #'NZ_AKVY01000001.1'
