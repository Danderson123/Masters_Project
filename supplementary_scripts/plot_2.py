...
tenthousand = glob.glob("accessory_results/tmpldhqwobd/*.csv")
...
#         pass
    ...
    ax_2.plot(thresh_list, sense, label = str(kmer_length), color='sienna')
    ax_2.set_xlim([0,1])
    ax_2.set_ylim([0,1])
    ax_2.scatter(thresh_list, sense, color='sienna', s=15)
...
#fig.savefig('zoomed_accessory_plot.pdf')
